...
#include <QStringList>
#include <QTimer>
SerialConnection::SerialConnection(QObject *) : SerialLinkInterface(),
...
bool SerialConnection::setBaudRateType(int )
{
    return true;
}
bool SerialConnection::setFlowType(int )
{
    return true;
}
bool SerialConnection::setParityType(int )
{
    return true;
}
bool SerialConnection::setDataBitsType(int )
{
    return true;
}
bool SerialConnection::setStopBitsType(int )
{
    return true;
}
