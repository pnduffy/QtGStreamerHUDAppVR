...
SSDP_Client::SSDP_Client(asio::io_service& io_service, string my_own_ip, string camera_service_url)
	...
	timer(io_service) 
{
	...
	if (camera_service_url.length() == 0)
	{
	...
	{
		description_url = camera_service_url;
	}
};
