...
* creating the UAS. 
*/
UAS::UAS(MAVLinkProtocol* , int id) : UASInterface(),
    uasId(id),
    ...
    lastSendTimeSensors(0)
{
    ...
    m_heartbeatsEnabled = false; //MainWindow::instance()->heartbeatEnabled(); //Default to sending heartbeats
...
*/
void UAS::forwardMessage(mavlink_message_t)
{
}
