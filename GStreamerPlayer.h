...
public:
    ...
    Q_PROPERTY(bool swapColorMatrix READ getSwapColorMatrix WRITE setSwapColorMatrix NOTIFY swapColorMatrixChanged)
    ...
    bool getSwapColorMatrix()
    {
        m_swapColorMatrix = m_videoSink->property("swap_color_matrix").toBool();
        return m_swapColorMatrix;
    }
    ...
    void setSwapColorMatrix(bool swap)
    {
        m_swapColorMatrix = swap;
        emit swapColorMatrixChanged(swap);
        m_videoSink->setProperty("swap_color_matrix", swap);
    }

    bool getSplitImage()
    {
        m_splitImage = m_videoSink->property("split_image").toBool();
        return m_splitImage;
    }
    ...
    {
        m_splitImage = value;
        m_videoSink->setProperty("split_image", value);
        emit splitImageChanged(value);
    }
...
signals:
    ...
    void swapColorMatrixChanged(bool);
    void messageBox(QString text);
	void splitImageChanged(bool);
