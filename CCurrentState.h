...
public:
    ...
    void setFlightMode(const wchar_t *mode) { wcsncpy_s(m_flightMode, MAX_BUF, mode, MAX_BUF); }
    void setDistUnit(const wchar_t *unit) { wcsncpy_s(m_distUnit, MAX_BUF, unit, MAX_BUF); }
    void setSpeedUnit(const wchar_t *unit) { wcsncpy_s(m_speedUnit, MAX_BUF, unit, MAX_BUF); }
	void setMessage(const wchar_t *msg) { wcsncpy_s(m_message, MAX_MESSAGE_LEN, msg, MAX_MESSAGE_LEN); }
...
private:
    ...
    wchar_t m_flightMode[MAX_BUF];
    wchar_t m_distUnit[MAX_BUF];
    wchar_t m_speedUnit[MAX_BUF];
